<template>
  <div class="about">
    <h1>Welcome to the DiscGenius about Page!</h1>
    <div class="spacer"/>
    <h3>This is Part of an Independent Coursework at HTW Berlin.</h3>
    <div class="spacer"/>
    ...
    <div>
      ...
      <div>
        <label class="aboutLabel">
          Vielen Dank für ihre Unterstützung in der Entwicklung dieser Applikation und für jeden Punkt an Feedback den sie beitragen werden.</label>
      </div>
    </div>
    <div class="spacer"/>
    <div>
